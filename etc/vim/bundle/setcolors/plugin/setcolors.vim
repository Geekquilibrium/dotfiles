...
let s:mycolors = [ 'github','solarized','vylight', 'summerfruit' ]

" Set list of color scheme names that we will use, except argument 'now' actually
...
function! s:HourColor()
  ...
  let nowcolors = 'gitub solarized molokai'
